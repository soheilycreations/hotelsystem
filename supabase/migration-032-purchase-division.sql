-- Purchasing always posted its expense to the "restaurant" P&L division —
-- room supplies (linen, toiletries, etc.) bought through this screen were
-- silently overstating restaurant costs. Lets the cashier pick which
-- division the bill belongs to, same choice already offered on the plain
-- Expenses form.
