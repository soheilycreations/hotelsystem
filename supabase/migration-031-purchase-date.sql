-- Lets a purchase be recorded against a past date (e.g. entering
-- yesterday's supplier bill today) instead of always posting to
-- current_date — both the purchase record and its linked expense now use
-- the picked date.
